...
![The Artistic Bird](images/chapter18_images/chapter18Peacock.png){width=100% height=auto}
...
![Generated with Qwen-Image — cinematic concept art](images/chapter18_images/artisticBirdQwenImage.png){width=100% fig-number=false fig-align="center" fig-cap="Artistic Bird generated with Qwen-Image (local inference)."}
...
Running locally on my AI workstation (RTX 5090 GPU + 128 GB RAM + AMD Ryzen 9 9950X3D), this system leverages Hugging Face’s `DiffusionPipeline` to produce high-fidelity art directly from Python.
...
- CPU: AMD Ryzen 9 9950X3D · RAM: 128 GB
- OS/Stack: Ubuntu 24.04, CUDA 12.5, PyTorch 2.4, diffusers 0.30
...
image = pipe(
  prompt="A majestic AI-generated bird with bioluminescent feathers reflecting streams of data...",
...
>A majestic AI-generated bird inspired by a peacock, spreading its wings into a brilliant fractal explosion of color and light...
>(Negative prompt: “no text, no watermark, no blur, lowres”)
