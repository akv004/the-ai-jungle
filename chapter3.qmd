...
![Figure 3.X — The Swift Fox on the Boosting Trail. LightGBM is the lean robotic fox sprinting along the same boosting trail XGBoost blazed, leaving behind the heavier predecessors of the gradient-boosting family.](images/chapter3_images/swift_fox_lightgbm.png){fig-align="center" width="80%"}
