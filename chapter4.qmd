...
![Figure 4.1 — The Firing Canopy Node. A single artificial neuron watches the jungle canopy, gathering many faint signals into one decisive pulse. Inputs arrive as glowing threads; when the learned threshold is crossed, the node fires and passes its signal onward.](images/chapter4_images/firing_canopy_node.png){fig-align="center" width="80%"}
...
![Figure 4.2 — The Owl's Memory Rings. Information rises through layered rings of perception: simple glimmers become edges, edges become shapes, and shapes become a clear concept the Owl can recognize.](images/chapter4_images/insightful_owl_memory_rings.png){fig-align="center" width="80%"}
...
![Layered neural architecture inside the Robotic Owl, showing how inputs pass through hidden layers before becoming a final prediction.](images/chapter4/layerArchRoboticOwl.png){width=100% height=auto}
...
![Figure 4.3 — The Hawk's Spatial Grid. A robotic hawk scans the forest through overlapping glowing windows, showing how convolutional filters sweep across an image to detect local patterns wherever they appear.](images/chapter4_images/hawk_spatial_grid.png){fig-align="center" width="80%"}
...
::: {.callout-note}
## Quick Reference: Choosing the Right Neural Network

| Network Type | Jungle Animal | Best For | Real-World Examples |
|:---|:---|:---|:---|
| **CNN** | Hawk | Images, spatial patterns | Medical imaging, self-driving cars |
| **RNN/LSTM** | Owl | Sequences, time series | Speech recognition, stock prediction |
| **Transformer** | (Coming soon!) | Long-context text, multimodal | ChatGPT, translation, coding assistants |
