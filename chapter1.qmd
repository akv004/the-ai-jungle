...
![The AI Jungle: Where Artificial Intelligence Lives Today—from voice assistants and smart recommendations to autonomous systems, healthcare AI, and creative applications.](images/chapter1_images/ai_ecosystem_v2.png){#fig-ai-ecosystem}
...
![The Tiger's Journey: A Brief History of AI—from Turing's 1950s question through the AI Winters, Deep Blue's chess victory, AlphaGo's triumph, to the modern LLM era.](images/chapter1_images/ai_history_timeline_v2.png){#fig-ai-history}
...
%%| fig-cap: "The AI Hierarchy: Deep Learning is a subset of Machine Learning, which is a subset of Artificial Intelligence."
flowchart TB
...
![The Robotic Tiger in a lab, representing the full AI development cycle from sensing data to training, validation, and deployment.](images/chapter1_images/TigerRoboLab.png){fig-align="center" width="80%"}
...
%%| fig-cap: "The ML Pipeline: How a robotic tiger learns to hunt—from data collection to real-world deployment."
flowchart LR
