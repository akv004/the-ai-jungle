...
![The Fox's Toolkit: A visual map of Reinforcement Learning algorithm families—Value-Based (Q-Learning, DQN), Policy-Based (REINFORCE, Policy Gradient), Actor-Critic (PPO, SAC), Model-Based (MuZero, Dreamer), and Modern RL (RLHF, Offline RL).](images/chapter5/rl_algorithm_ecosystem.png){#fig-rl-ecosystem}
