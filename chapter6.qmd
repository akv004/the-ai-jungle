...
![Figure 6.8 — The Owl Tuning Its Alarm Bells. The steady elephant lives inside a small tight halo of alarm; the erratic monkey inside a much wider one. The Owl scales each bell to the creature's natural volatility, not to a single fixed threshold.](images/chapter6_images/owl_dynamic_zscore.png){fig-align="center" width="80%"}
